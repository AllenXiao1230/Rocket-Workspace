...
export default async function Home({ searchParams }: { searchParams: Promise<{ project?: string; document?: string }> }) {
  ...
  const { project: requestedProjectId, document: requestedDocumentId } = await searchParams;
