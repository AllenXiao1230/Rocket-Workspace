...
export type TeamMember = { id: string; role: "OWNER" | "ADMIN" | "EDITOR" | "VIEWER"; nickname: string | null; teamGroup: string | null; jobTitle: string | null; user: { id: string; name: string; email: string; avatarEmoji?: string | null; avatarUrl?: string | null } };
