...
type GanttTask = { id: string; title: string; status: string; startDate: string | Date | null; dueDate: string | Date | null; assignee?: { name: string } | null };
