...
export function WorkspaceShell({ user, workspace, workspaceId, project, projects, documents: initialDocuments, initialActiveId, databases: initialDatabases, records, teamMembers: initialTeamMembers }: { user: { name: string; role: string; avatarEmoji?: string | null }; workspace: string; workspaceId: string; project: { id: string; name: string; code: string }; projects: Array<{ id: string; name: string; code: string }>; documents: DocumentItem[]; initialActiveId?: string; databases: DatabaseData[]; records: RecordData; teamMembers: TeamMember[] }) {
