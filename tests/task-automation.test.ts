...
describe("task recurrence rules", () => {
  it("uses one canonical parser for daily, weekly, and monthly schedules", () => {
    ...
    expect(nextRecurrenceOccurrence("FREQ=DAILY;INTERVAL=2", anchor)?.toISOString()).toBe("2026-02-02T00:00:00.000Z");
    expect(nextRecurrenceOccurrence("FREQ=WEEKLY;INTERVAL=2", anchor)?.toISOString()).toBe("2026-02-14T00:00:00.000Z");
